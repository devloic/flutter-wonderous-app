...
class CollectibleFoundScreen extends StatelessWidget {
      ...
      Center(
        child: FractionallySizedBox(
          ...
          child: Hero(
            ...
            .animate()
            .scale(begin: Offset(1.5, 0), end: Offset(3, 0), curve: Curves.easeInExpo, delay: t, duration: t * 3)
            .fadeOut(),
      )
    ]);
  }
  ...
  Widget _buildImage(BuildContext context) {
    ...
    return AppImage(image: imageProvider, scale: 1.0)
        ...
        .scale(begin: Offset(0.3, 0), duration: t * 2, curve: Curves.easeOutExpo, alignment: Alignment(0, 0.7));
  }
  ...
  Widget _buildRibbon(BuildContext context) {
    ...
    return _AnimatedRibbon($strings.collectibleFoundTitleArtifactDiscovered.toUpperCase())
        .animate()
        .scale(begin: Offset(0.3, 0), duration: t * 2, curve: Curves.easeOutExpo, alignment: Alignment(0, -1));
  }
